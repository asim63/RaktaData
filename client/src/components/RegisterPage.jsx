...
const RegisterPage = ({ setPage, onLogin, dark, onToggleTheme }) => {
  ...
  const handleReg = async () => {
    ...
    if (!form.name || !form.username || !form.password || !form.phone_no) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Divider */}
          <div
            style={{ borderTop: "1px solid #2A2D3A", marginBottom: "24px" }}
          />
      ...
      {toast &&
        createPortal(
          <div
            className={`toast${toast.type === "success" ? " toast-green" : " toast-red"}`}
          >
